...
######################################             Тестові дані:         #############################################
def testlist():
    frm = Form('Як називається основна зброя в грі кс2?', 'M4A1_S і AK-47',
               'USP_S і Glock', 'AWP і Ssg 08')
    questions_listmodel.form_list.append(frm)

    frm = Form('Що потрібно зробити, щоб вийграти раунд?', 'убити всіх противників і роздефать або заплентити бомбу',
               'розкидати сайт і заплентит бомбу', 'померти від противників',)
    questions_listmodel.form_list.append(frm)

    frm = Form('Які існуютть типи гранат?', 'кокотель молотова, флешка, смок, хає',
